...
- **Layer code**: `data_pub_atm`
- **Host**: `ebarilga`
- **Geometry**: Point
- **Features**: 328 (counts 2026-09-13)
- **Attributes**: unprobed
- **Raw files**: `tools/sources/ebarilga/raw/ebarilga-data_pub_atm.{geojson,csv,meta.json}`

## Title

- **EN**: ATMs — Ulaanbaatar (eBarilga geoportal)
- **MN**: АТМ — Улаанбаатар (eBarilga геопортал)

## Description

ATMs in Ulaanbaatar from the eBarilga geoportal
(328 Point features). Attribute richness not yet surveyed; check the CSV headers.
...
python3 query_api.py --layer data_pub_atm          # live count vs catalog
python3 fetch_data.py --layer data_pub_atm --output ../../tools/sources/ebarilga/raw --with-attributes
```
