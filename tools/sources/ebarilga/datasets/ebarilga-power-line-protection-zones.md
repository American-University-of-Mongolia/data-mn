# Dataset: Power line protection zones

## Identification

- **ID**: `ebarilga-power-line-protection-zones`
- **Source**: `ebarilga`
...
- **Layer code**: `pz_city_line`
- **Host**: `transco`
- **Geometry**: Polygon
- **Features**: 49 (counts 2026-09-13)
- **Attributes**: unprobed
- **Raw files**: `tools/sources/ebarilga/raw/ebarilga-pz_city_line.{geojson,csv,meta.json}`

## Title

- **EN**: Power line protection zones — Ulaanbaatar (eBarilga geoportal)
- **MN**: Дамжуулах шугам сүлжээний хамгаалалтын зурвас — Улаанбаатар (eBarilga геопортал)

## Description

Power line protection zones in Ulaanbaatar from the eBarilga geoportal
(49 Polygon features). Attribute richness not yet surveyed; check the CSV headers.
...
python3 query_api.py --layer pz_city_line          # live count vs catalog
python3 fetch_data.py --layer pz_city_line --output ../../tools/sources/ebarilga/raw --with-attributes --insecure-tls
```
