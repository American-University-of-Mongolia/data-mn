# Dataset: Lake protection (200m)

## Identification

- **ID**: `ebarilga-lake-protection-200m`
- **Source**: `ebarilga`
...
- **Layer code**: `pz_nuur_200m`
- **Host**: `ebarilga`
- **Geometry**: Polygon
- **Features**: 2 (counts 2026-09-13)
- **Attributes**: unprobed
- **Raw files**: `tools/sources/ebarilga/raw/ebarilga-pz_nuur_200m.{geojson,csv,meta.json}`

## Title

- **EN**: Lake protection (200m) — Ulaanbaatar (eBarilga geoportal)
- **MN**: Нуурын хамгаалалт 200м — Улаанбаатар (eBarilga геопортал)

## Description

Lake protection (200m) in Ulaanbaatar from the eBarilga geoportal
(2 Polygon features). Attribute richness not yet surveyed; check the CSV headers.
...
python3 query_api.py --layer pz_nuur_200m          # live count vs catalog
python3 fetch_data.py --layer pz_nuur_200m --output ../../tools/sources/ebarilga/raw --with-attributes
```
