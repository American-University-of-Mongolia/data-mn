...
- **Layer code**: `data_pub_bank`
- **Host**: `ebarilga`
- **Geometry**: Point
- **Features**: 228 (counts 2026-09-13)
- **Attributes**: unprobed
- **Raw files**: `tools/sources/ebarilga/raw/ebarilga-data_pub_bank.{geojson,csv,meta.json}`

## Title

- **EN**: Banks — Ulaanbaatar (eBarilga geoportal)
- **MN**: Банк — Улаанбаатар (eBarilga геопортал)

## Description

Banks in Ulaanbaatar from the eBarilga geoportal
(228 Point features). Attribute richness not yet surveyed; check the CSV headers.
...
python3 query_api.py --layer data_pub_bank          # live count vs catalog
python3 fetch_data.py --layer data_pub_bank --output ../../tools/sources/ebarilga/raw --with-attributes
```
