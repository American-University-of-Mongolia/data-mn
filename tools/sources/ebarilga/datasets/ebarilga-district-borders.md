# Dataset: District borders

## Identification

- **ID**: `ebarilga-district-borders`
- **Source**: `ebarilga`
...
- **Layer code**: `district_border`
- **Host**: `ebarilga`
- **Geometry**: Polygon
- **Features**: 9 (counts 2026-09-13)
- **Attributes**: unprobed
- **Raw files**: `tools/sources/ebarilga/raw/ebarilga-district_border.{geojson,csv,meta.json}`

## Title

- **EN**: District borders — Ulaanbaatar (eBarilga geoportal)
- **MN**: Дүүргийн хил — Улаанбаатар (eBarilga геопортал)

## Description

District borders in Ulaanbaatar from the eBarilga geoportal
(9 Polygon features). Attribute richness not yet surveyed; check the CSV headers.
...
python3 query_api.py --layer district_border          # live count vs catalog
python3 fetch_data.py --layer district_border --output ../../tools/sources/ebarilga/raw --with-attributes
```
