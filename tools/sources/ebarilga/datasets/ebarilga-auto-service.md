# Dataset: Auto service

## Identification

- **ID**: `ebarilga-auto-service`
- **Source**: `ebarilga`
...
- **Layer code**: `data_auto_service`
- **Host**: `ebarilga`
- **Geometry**: Point
- **Features**: 107 (counts 2026-09-13)
- **Attributes**: unprobed
- **Raw files**: `tools/sources/ebarilga/raw/ebarilga-data_auto_service.{geojson,csv,meta.json}`

## Title

- **EN**: Auto service — Ulaanbaatar (eBarilga geoportal)
- **MN**: Авто үйлчилгээ — Улаанбаатар (eBarilga геопортал)

## Description

Auto service in Ulaanbaatar from the eBarilga geoportal
(107 Point features). Attribute richness not yet surveyed; check the CSV headers.
...
python3 query_api.py --layer data_auto_service          # live count vs catalog
python3 fetch_data.py --layer data_auto_service --output ../../tools/sources/ebarilga/raw --with-attributes
```
