...
- **Layer code**: `data_cul_statue`
- **Host**: `ebarilga`
- **Geometry**: Point
- **Features**: 319 (counts 2026-09-13)
- **Attributes**: medium
- **Raw files**: `tools/sources/ebarilga/raw/ebarilga-data_cul_statue.{geojson,csv,meta.json}`

## Title

- **EN**: Statues — Ulaanbaatar (eBarilga geoportal)
- **MN**: Хөшөө — Улаанбаатар (eBarilga геопортал)

## Description

Statues in Ulaanbaatar from the eBarilga geoportal
(319 Point features). Basic Mongolian-only attributes (usually name and/or address; see CSV headers).
...
python3 query_api.py --layer data_cul_statue          # live count vs catalog
python3 fetch_data.py --layer data_cul_statue --output ../../tools/sources/ebarilga/raw --with-attributes
```
...
- Address in sample; name often missing
