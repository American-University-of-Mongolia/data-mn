...
- **Layer code**: `data_pub_hotel`
- **Host**: `ebarilga`
- **Geometry**: Point
- **Features**: 241 (counts 2026-09-13)
- **Attributes**: unprobed
- **Raw files**: `tools/sources/ebarilga/raw/ebarilga-data_pub_hotel.{geojson,csv,meta.json}`

## Title

- **EN**: Hotels — Ulaanbaatar (eBarilga geoportal)
- **MN**: Зочид буудал — Улаанбаатар (eBarilga геопортал)

## Description

Hotels in Ulaanbaatar from the eBarilga geoportal
(241 Point features). Attribute richness not yet surveyed; check the CSV headers.
...
python3 query_api.py --layer data_pub_hotel          # live count vs catalog
python3 fetch_data.py --layer data_pub_hotel --output ../../tools/sources/ebarilga/raw --with-attributes
```
