# Dataset: Sports halls

## Identification

- **ID**: `ebarilga-sports-halls`
- **Source**: `ebarilga`
...
- **Layer code**: `data_sport_halls`
- **Host**: `ebarilga`
- **Geometry**: Point
- **Features**: 208 (counts 2026-09-13)
- **Attributes**: unprobed
- **Raw files**: `tools/sources/ebarilga/raw/ebarilga-data_sport_halls.{geojson,csv,meta.json}`

## Title

- **EN**: Sports halls — Ulaanbaatar (eBarilga geoportal)
- **MN**: Спорт заалууд — Улаанбаатар (eBarilga геопортал)

## Description

Sports halls in Ulaanbaatar from the eBarilga geoportal
(208 Point features). Attribute richness not yet surveyed; check the CSV headers.
...
python3 query_api.py --layer data_sport_halls          # live count vs catalog
python3 fetch_data.py --layer data_sport_halls --output ../../tools/sources/ebarilga/raw --with-attributes
```
