...
- **Host**: `ebarilga`
- **Geometry**: Polygon
- **Features**: 829 (counts 2026-09-13)
- **Attributes**: unprobed
- **Raw files**: `tools/sources/ebarilga/raw/ebarilga-d902_as.{geojson,csv,meta.json}`

## Title

- **EN**: Forest — Ulaanbaatar (eBarilga geoportal)
- **MN**: Ой мод — Улаанбаатар (eBarilga геопортал)

## Description

Forest in Ulaanbaatar from the eBarilga geoportal
(829 Polygon features). Attribute richness not yet surveyed; check the CSV headers.
...
python3 query_api.py --layer d902_as          # live count vs catalog
python3 fetch_data.py --layer d902_as --output ../../tools/sources/ebarilga/raw --with-attributes
```
