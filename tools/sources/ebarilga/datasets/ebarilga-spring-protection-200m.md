# Dataset: Spring protection (200m)

## Identification

- **ID**: `ebarilga-spring-protection-200m`
- **Source**: `ebarilga`
...
- **Layer code**: `pz_bulag_200m`
- **Host**: `ebarilga`
- **Geometry**: Polygon
- **Features**: 10 (counts 2026-09-13)
- **Attributes**: unprobed
- **Raw files**: `tools/sources/ebarilga/raw/ebarilga-pz_bulag_200m.{geojson,csv,meta.json}`

## Title

- **EN**: Spring protection (200m) — Ulaanbaatar (eBarilga geoportal)
- **MN**: Булгийн хамгаалалт 200м — Улаанбаатар (eBarilga геопортал)

## Description

Spring protection (200m) in Ulaanbaatar from the eBarilga geoportal
...
python3 query_api.py --layer pz_bulag_200m          # live count vs catalog
python3 fetch_data.py --layer pz_bulag_200m --output ../../tools/sources/ebarilga/raw --with-attributes
```
