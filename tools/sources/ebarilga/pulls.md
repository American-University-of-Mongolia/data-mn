...
Status 2026-09-13: geometries done for ALL 75 layers (401,034 features,
audit-clean; 12 poison ids skipped, see meta.json files). Attribute backfill
for all 70 eligible layers launched detached 05:03 UTC, log
`/tmp/ebarilga_attrs.log` (~14h at 1 req/s). A-column boxes get checked when
it finishes.
