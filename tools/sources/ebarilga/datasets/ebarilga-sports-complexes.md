# Dataset: Sports complexes

## Identification

- **ID**: `ebarilga-sports-complexes`
- **Source**: `ebarilga`
...
- **Layer code**: `data_sport_complex`
- **Host**: `ebarilga`
- **Geometry**: Point
- **Features**: 95 (counts 2026-09-13)
- **Attributes**: unprobed
- **Raw files**: `tools/sources/ebarilga/raw/ebarilga-data_sport_complex.{geojson,csv,meta.json}`

## Title

- **EN**: Sports complexes — Ulaanbaatar (eBarilga geoportal)
- **MN**: Спорт комплекс — Улаанбаатар (eBarilga геопортал)

## Description

Sports complexes in Ulaanbaatar from the eBarilga geoportal
(95 Point features). Attribute richness not yet surveyed; check the CSV headers.
...
python3 query_api.py --layer data_sport_complex          # live count vs catalog
python3 fetch_data.py --layer data_sport_complex --output ../../tools/sources/ebarilga/raw --with-attributes
```
