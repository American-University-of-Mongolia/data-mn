# Dataset: Telecom relay stations

## Identification

- **ID**: `ebarilga-telecom-relay-stations`
- **Source**: `ebarilga`
...
- **Layer code**: `pz_comm_atc`
- **Host**: `ebarilga`
- **Geometry**: Polygon
- **Features**: 11 (counts 2026-09-13)
- **Attributes**: unprobed
- **Raw files**: `tools/sources/ebarilga/raw/ebarilga-pz_comm_atc.{geojson,csv,meta.json}`

## Title

- **EN**: Telecom relay stations — Ulaanbaatar (eBarilga geoportal)
- **MN**: Холбоо дамжуулах станц — Улаанбаатар (eBarilga геопортал)

## Description

Telecom relay stations in Ulaanbaatar from the eBarilga geoportal
(11 Polygon features). Attribute richness not yet surveyed; check the CSV headers.
...
python3 query_api.py --layer pz_comm_atc          # live count vs catalog
python3 fetch_data.py --layer pz_comm_atc --output ../../tools/sources/ebarilga/raw --with-attributes
```
