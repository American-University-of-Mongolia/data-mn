# Dataset: Khoroo offices

## Identification

- **ID**: `ebarilga-khoroo-offices`
- **Source**: `ebarilga`
...
- **Layer code**: `map_office_khoroo`
- **Host**: `ebarilga`
- **Geometry**: Point
- **Features**: 167 (counts 2026-09-13)
- **Attributes**: unprobed
- **Raw files**: `tools/sources/ebarilga/raw/ebarilga-map_office_khoroo.{geojson,csv,meta.json}`

## Title

- **EN**: Khoroo offices — Ulaanbaatar (eBarilga geoportal)
- **MN**: Хорооны байр — Улаанбаатар (eBarilga геопортал)

## Description

Khoroo offices in Ulaanbaatar from the eBarilga geoportal
(167 Point features). Attribute richness not yet surveyed; check the CSV headers.
...
python3 query_api.py --layer map_office_khoroo          # live count vs catalog
python3 fetch_data.py --layer map_office_khoroo --output ../../tools/sources/ebarilga/raw --with-attributes
```
